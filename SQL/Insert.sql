...
('Logistika 2000','Software di logistica trasporti',TRUE,'Attivo','Z:config/server/software','Produzione beni e servizi','Alta'),
('Manutenzione Logistika','Manutenzione del software',FALSE,'Attivo',NULL,'Produzione beni e servizi','Media');
...
('info@trazport.it', '0522556641'),
('contatti@megazzino.com', '059558842');
...
('Closed source', 'Antivirus',NULL, 5),
('Proprietario', 'Prodotto di venditra', 'Sono stati prese le seguenti precauzioni: ...', 7);
...
('Cliente', 'Trazport srl', 'IT08875543550', FALSE, 7),
('Cliente', 'Megazzino srl', 'IT06586543010', FALSE, 8);
...
('Vendita', 'Software', 'Vendita Logistika 2000', '2026-01-01', NULL, 'Alto', 7, 7),
('Vendita', 'Software', 'Vendita Logistika 2000', '2025-12-01', NULL, 'Alto', 7, 8),
('Vendita', 'Manutenzione', 'Manutenzione software Logistika 2000', '2025-12-01', NULL, 'Medio', 8, 8);
...
('Server', 1, NULL, 'Agenzia delle entrate', NULL, NULL, 'Monodirezionale', 'Trasmissione fatture elettroniche', 1, '2024-06-20', 'Attivo'),
...
(3, 1, '2021-09-01', '2024-09-01', FALSE, 'In sede', '2 years', 1, 'Accesso fisico con badge');
...
(NULL, 'Miglioramento attuato','Migrazione backup su supporti cifrati','Sono stati spostati i backup su NAS cifrati','2026-05-25','2026-05-30',NULL,'Trasferimento riuscito',1,NULL),
...
INSERT INTO procedura (raci_id, finalita, tipologia, nome, procedimento, con_attivazione, con_disattivazione, proced_report, data_creazione, data_dismissione, link_documento, approvato) VALUES
...
(4, 'Operativo/tecnico', '2026-06-01', NULL, 'Guasto hardware su server database', 'Servizi rallentati per 3 ore, mandata comunicazione all''ACN', 'Usura componente hardware', 'Rallentamento servizi per 3 ore', 'Media', 'In corso');